var e,t=globalThis,n={},o=0/0,r=/^\s+|\s+$/g,i=/^[-+]0x[0-9a-f]+$/i,a=/^0b[01]+$/i,u=/^0o[0-7]+$/i,c=parseInt,p="object"==typeof t&&t&&t.Object===Object&&t,s="object"==typeof self&&self&&self.Object===Object&&self,f=p||s||Function("return this")(),l=Object.prototype.toString,m=Math.max,d=Math.min,y=function(){return f.Date.now()};function v(e){var t=typeof e;return!!e&&("object"==t||"function"==t)}function g(e){if("number"==typeof e)return e;if("symbol"==typeof(t=e)||t&&"object"==typeof t&&"[object Symbol]"==l.call(t))return o;if(v(e)){var t,n="function"==typeof e.valueOf?e.valueOf():e;e=v(n)?n+"":n}if("string"!=typeof e)return 0===e?e:+e;e=e.replace(r,"");var p=a.test(e);return p||u.test(e)?c(e.slice(2),p?2:8):i.test(e)?o:+e}n=function(e,t,n){var o,r,i,a,u,c,p=0,s=!1,f=!1,l=!0;if("function"!=typeof e)throw TypeError("Expected a function");function $(t){var n=o,i=r;return o=r=void 0,p=t,a=e.apply(i,n)}function b(e){var n=e-c,o=e-p;return void 0===c||n>=t||n<0||f&&o>=i}function h(){var e,n,o,r=y();if(b(r))return j(r);u=setTimeout(h,(e=r-c,n=r-p,o=t-e,f?d(o,i-n):o))}function j(e){return(u=void 0,l&&o)?$(e):(o=r=void 0,a)}function T(){var e,n=y(),i=b(n);if(o=arguments,r=this,c=n,i){if(void 0===u)return p=e=c,u=setTimeout(h,t),s?$(e):a;if(f)return u=setTimeout(h,t),$(c)}return void 0===u&&(u=setTimeout(h,t)),a}return t=g(t)||0,v(n)&&(s=!!n.leading,i=(f="maxWait"in n)?m(g(n.maxWait)||0,t):i,l="trailing"in n?!!n.trailing:l),T.cancel=function(){void 0!==u&&clearTimeout(u),p=0,o=c=r=u=void 0},T.flush=function(){return void 0===u?a:j(y())},T};const $=document.querySelector("#input"),b=document.querySelector("#countryDiv");let h=[];function j(e,t){let n,o,r,i;for(let a=0;a<e.length;a++)if(e[a].name.common.toLowerCase()===t.toLowerCase()){n=e[a].name.common,i=!0===(o=e[a]).independent?"Independent country":"Dependent country";let t=Object.keys(o.currencies||{})[0],u=o.currencies?.[t]||{},c=Object.values(o.languages);r=`
